...
<div style="background-color: #fafbfd; margin: -1em -1em 1em -1em; padding: 1em 0 0; border-left: 1px solid #e0e2e7;">
    ...
    <ul class="nav nav-tabs mb-4 px-3">
        <li class="nav-item">
            <a class="nav-link{{ (Request::is('*/reported')) ? ' active' : '' }}" href="/admin/reported">Reported</a>
        </li>
        <li class="nav-item">
            <a class="nav-link{{ (Request::is('*/resolved')) ? ' active' : '' }}" href="/admin/reported/resolved">Resolved</a>
        </li>
    </ul>
</div>
