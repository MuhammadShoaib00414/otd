...
@section('page-content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3" style="max-width: 750px;">
        <h2 class="mb-0 pb-0">GDPR</h2>
        <a href="/admin/system/onboarding/step-preview?step=gdpr" class="btn btn-sm btn-outline-primary" onclick="openinnewwindow(this.href)" target="_blank">View step</a>
    </div>
    <hr>
            ...
            <div class="p-3 mb-3" style="background-color: #eee; border-radius: 5px;">
                <div class="form-check">
                    ...
                    <label style="vertical-align: middle;" class="form-check-label" for="groups[active]">
                      <b>Active</b><br>
                      <span class="text-muted">Your platform is configured for GDPR compliance, so this step cannot be removed.</span>
                    </label>
                </div>
            </div>
