...
<form method="post" action="/admin/registration/{{ $page->id }}/tickets" class="col-md-6 mx-auto" id="app">
	@csrf
	<h4>New Ticket</h4>
  @if ($errors->any())
	...
	<div class="form-group mt-3">
		...
		<input type="text" name="name" id="name" class="form-control" required maxlength="250">
	</div>
	<div class="form-group mt-3">
		...
		<div class="input-group">
			...
			<input type="text" name="price" id="price" class="form-control" maxlength="6" required value="0">
		</div>
	</div>
