        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              <form action="/admin/budgets/{{ $budget->id }}/expenses/{{ $expense->id }}" method="post">
                @method('delete')
                @csrf
                <button type="submit" class="btn btn-sm btn-outline-primary mr-1" id="deleteExpense"><i class="fa fa-trash"></i></button>
              </form>
            </div>
            <form method="post" action="/admin/budgets/{{ $budget->id }}/expenses/{{ $expense->id }}">
              @csrf
              @method('put')
              <div class="form-row">
                <div class="col-6">
              ...
              <div class="form-group">
                ...
                <select name="category_id" class="form-control">
                  <option {{ ($expense->expense_category_id == null) ? 'selected' : ''}} value="null">No category</option>
              ...
              <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary">@lang('general.save') expense</button>
              </div>
            </form>
          </div>
        </div>
