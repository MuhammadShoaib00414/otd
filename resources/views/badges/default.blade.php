...
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="3em" height="3em" viewBox="0 0 930.3 930.301" style="enable-background:new 0 0 930.3 930.301;"
	 xml:space="preserve">
<g>
	<g>
		<path fill="{{ getThemeColors()->accent['300'] }}" d="M701.709,518.301L694.31,523c-2.5,1.6-4.601,3.699-6.101,6.1l-31,48.701c-9.6,15.1-26.1,24.6-44,25.398l-57.7,2.5
		...
		<path fill="{{ getThemeColors()->accent['300'] }}" d="M470.61,640.801c-8.8,0-17.601-2.102-25.4-6.201l-14.399-7.5l-36.9-19.1c-2.6-1.301-5.5-2.1-8.3-2.199l-57.7-2.5
		...
		<path fill="{{ getThemeColors()->accent['300'] }}" d="M746.509,242.6c-3.399-6.5-5.3-13.6-5.6-20.9l-2.5-57.6c-0.4-8.2-4.7-15.6-11.6-20l-48.7-31c-6.2-3.9-11.4-9.2-15.3-15.3
