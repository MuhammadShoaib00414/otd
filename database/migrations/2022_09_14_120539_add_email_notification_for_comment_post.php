...
class AddEmailNotificationForCommentPost extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        EmailNotification::where('name', 'User Send comments on post')->delete();
    }
}
