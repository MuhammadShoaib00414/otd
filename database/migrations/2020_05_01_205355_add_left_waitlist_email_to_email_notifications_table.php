...
class AddLeftWaitlistEmailToEmailNotificationsTable extends Migration
{
    /**
     * Run the migrations.
     *
                            ...
                            <re-container>
                                <re-card background-color="#ffffff" padding="40px 20px">
                                    <re-block padding="0 0 20px 0">
                                        <re-heading type="h1" align="center">You\'re Off The Waitlist<br></re-heading>
                                    </re-block>
                                    <re-block align="center">
                                        <re-text align="center" font-size="15px">
                                            You\'re off the waitlist for an event.</re-text>
                                    </re-block>
                                    <re-block align="center" padding="40px 0 20px 0">
                                        <re-button href="@cta" background-color="#F29181">View Event</re-button>
                                    </re-block>
                                </re-card>
                            </re-container>
                            <re-spacer height="2px"></re-spacer>
    ...
    {
        DB::table('email_notifications')->where('name', 'On Move Off Waitlist')->delete();
    }
}
