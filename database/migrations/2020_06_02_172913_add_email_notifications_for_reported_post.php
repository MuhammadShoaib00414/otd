...
class AddEmailNotificationsForReportedPost extends Migration
{
    /**
     * Run the migrations.
     *
                        ...
                        <re-container>
                            <re-card background-color="#ffffff" padding="40px 20px">
                                <re-block padding="0 0 20px 0">
                                    <re-heading type="h1" align="center">A post has been reported in @groupName</re-heading>
                                </re-block>
                                <re-block align="center">
                                    <re-text align="center" font-size="15px">@reportedBy has just reported a post!</re-text>
                                </re-block>
                                <re-block align="center" padding="40px 0 20px 0">
                                    <re-button href="@cta" background-color="#F29181" color="#ffffff">Check it out</re-button>
                                </re-block>
                            </re-card>
                        </re-container>
                        <re-spacer height="2px"></re-spacer>
    ...
    {
        EmailNotification::where('name', 'On post reported')->delete();
    }
}
